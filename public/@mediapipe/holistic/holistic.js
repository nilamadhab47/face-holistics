...
*/
  ...
  z("Promise", function (a) {
    ...
    b.prototype.D = function () {
      ...
      "function" === typeof g
        ...
        : ((g = y.document.createEvent("CustomEvent")),
  ...
  function Ta(a) {
    ...
    if (0 === a) 0 < 1 / a ? (I = J = 0) : ((J = 0), (I = 2147483648));
      ...
      if (3.4028234663852886e38 < a) (J = 0), (I = (b | 2139095040) >>> 0);
        ...
        (a = Math.round(a / Math.pow(2, -149))), (J = 0), (I = (b | a) >>> 0);
      else {
    ...
    if (16 > a.length) Ra(Number(a));
      ...
      for (
        ...
        (d = Number(a.slice(d, e))),
          (J *= 1e6),
          (I = 1e6 * I + d),
          4294967296 <= I && ((J += (I / 4294967296) | 0), (I %= 4294967296));
      b &&
        ((b = A(Sa(I, J))),
        (a = b.next().value),
        (b = b.next().value),
  ...
  var cb = void 0,
    db,
    eb = "undefined" !== typeof TextDecoder,
    fb,
  ...
  function lb(a) {
    ...
    var b = a.V;
    b =
      null == b || (Ga && null != b && b instanceof Uint8Array)
        ? b
        : "string" === typeof b
        ? La(b)
        : null;
  ...
  function mb(a) {
    if ("string" === typeof a) return { buffer: La(a), C: !1 };
    ...
    if (a.constructor === jb) return { buffer: lb(a) || Oa(), C: !0 };
  ...
  nb.prototype.s = function () {
    ...
    return 255 == d
      ...
      : 0 == d
      ? c * Math.pow(2, -149) * e
      : c * Math.pow(2, d - 150) * (e + Math.pow(2, 23));
  };
  function rb(a, b) {
  ...
  function O(a, b) {
    ...
    Object.defineProperties(a, {
      B: { value: b, configurable: !0, writable: !0, enumerable: !1 },
    });
    return b;
  }
  function Jb(a, b) {
    var c = P(a);
    (c & b) !== b &&
      (Object.isFrozen(a) && (a = Array.prototype.slice.call(a)), Q(a, c | b));
    return a;
  }
  function Kb(a, b) {
  ...
  function U(a, b, c, d) {
    ...
    b >= a.i || d
      ? (Wb(a)[b] = c)
      : ((a.o[b + a.G] = c), (a = a.A) && b in a && delete a[b]);
  }
  function Xb(a, b, c, d, e) {
    ...
    if (e) g & 2 || O(f, 2), c & 1 || Object.freeze(f);
      ...
      c & 1 || !h
        ? e && g & 16 && !h && Kb(f, 16)
        : ((f = Lb(Array.prototype.slice.call(f))), U(a, b, f, d));
    }
    return f;
  }
  function Yb(a, b) {
  ...
  function ec(a, b, c, d, e) {
    ...
    a = Xb(a, b, 2, void 0, !1);
    void 0 != e
      ? (f.splice(e, 0, c), a.splice(e, 0, c.o))
      : (f.push(c), a.push(c.o));
    c.C() && Kb(a, 8);
    return c;
  }
    ...
    switch (typeof a) {
      ...
      case "object":
        if (a)
          if (Array.isArray(a)) {
            if (0 !== (P(a) & 128))
              return (a = Array.prototype.slice.call(a)), Tb(a), a;
          } else {
  ...
  function nc(a, b, c) {
    c = void 0 === c ? Nb : c;
    if (null != a) {
      if (Ga && a instanceof Uint8Array)
        return a.length ? new jb(new Uint8Array(a), Pa) : kb();
      if (Array.isArray(a)) {
        var d = P(a);
        if (d & 2) return a;
  ...
  function qc(a, b) {
    ...
    for (var g = e ? c.length - 1 : c.length, h = 0; h < g; h++)
      pc(a, d, h - a.G, c[h], !1, f, b);
    if (e) for (var k in e) pc(a, d, +k, e[k], !0, f, b);
    return d;
  }
  function bc(a) {
    if (!R(a.o)) return a;
  ...
  function X(a, b, c) {
    ...
    a: {
      ...
      void 0 !== b && -1 < b
        ? ((this.i = Math.max(b, d + 1 - this.G)), (this.A = void 0))
        : (this.i = Number.MAX_VALUE);
    }
    if (!e && this.A && "g" in this.A)
      throw Error(
    ...
    if (c) {
      ...
      for (k = 0; k < c.length; k++)
        (g = c[k]),
          g < e
            ? ((g += this.G), (d = a[g]) ? rc(d, b) : (a[g] = Qb))
            : (n || (n = Wb(this)), (d = n[g]) ? rc(d, b) : (n[g] = Qb));
    }
  }
          ...
          for (var k = null, l, m; h < d; )
            (l = a[h++]),
              128 > l
                ...
                : ab(),
              8192 <= e.length && ((k = bb(k, e)), (e.length = 0));
          h = bb(k, e);
        }
        T(b, c, h);
        return !0;
    ...
    return D(function (p) {
      switch (p.h) {
        ...
        case 2:
          ...
          if ("object" === typeof window)
            return (
              Od("createMediapipeSolutionsWasm", { locateFile: a.locateFile }),
  ...
  function Ud(a) {
    ...
    return D(function (l) {
      if (1 == l.h) {
        if (a.h.graph && a.h.graph.url && a.ga === a.h.graph.url)
          return l.return();
        a.u = !0;
      ...
      a.D = {};
      if (a.h.listeners)
        for (f = A(a.h.listeners), g = f.next(); !g.done; g = f.next())
          (h = g.value), Vd(a, h);
      k = a.l;
      a.l = {};
      a.setOptions(k);
  ...
  x.setOptions = function (a, b) {
    ...
    if ((b = b || this.h.options)) {
      for (
        var d = [], e = [], f = {}, g = A(Object.keys(a)), h = g.next();
        !h.done;
        f = { X: f.X, Y: f.Y }, h = g.next()
      )
                    ...
                    for (w = 0; w < n.length; ++w) {
                      ...
                      if (t.ba)
                        for (v = 0; v < t.ba.length; ++v)
                          (E = q.data),
                            (M = E.addClassification),
                            (K = w),
                            (u = t.ba[v]),
                            (F = new cd()),
                            V(F, 2, u.score),
                            u.index && T(F, 1, u.index),
                            u.label && T(F, 3, u.label),
                            u.displayName && T(F, 4, u.displayName),
                            (u = F.l()),
                            M.call(E, K, u);
                    }
                    q = q.data;
    ...
    return D(function (v) {
      switch (v.h) {
        ...
        case 2:
          ...
          r = c[m];
          if ("string" === typeof r)
            return (t = d), (w = m), C(v, Yd(a, m, b[r]), 14);
          p = b[r.stream];
          if ("detection_list" === r.type) {
            if (p) {
              var E = p.getRectList();
              for (
                var M = p.getLandmarksList(),
                  K = p.getClassificationsList(),
                  u = [],
                  F = 0;
                F < E.size();
                ++F
  ...
  function Vd(a, b) {
    ...
    f = a.i.PacketListener.implement({
      onResults: function (h) {
        ...
        var m = a.listeners[c];
        m &&
          (a.I = Xd(a, k, b.outs).then(function (r) {
            r = m(r);
  ...
  function fe(a) {
    ...
    this.h = new Rd({
      ...
      files: [
        ...
        { simd: !1, url: "holistic_solution_wasm_bin.js" },
        { simd: !0, url: "holistic_solution_simd_wasm_bin.js" },
      ],
      ...
      listeners: [
        {
          wants:
            "left_hand_landmarks right_hand_landmarks face_landmarks pose_landmarks world_landmarks segmentation_mask image_transformed multi_face_geometry".split(
              " "
            ),
          outs: {
            ...
            za: { type: "proto", stream: "world_landmarks", transform: Hd },
      ...
      options: {
        ...
        minDetectionConfidence: {
          ...
          graphOptionXref: {
            ...
            calculatorName:
              "holisticlandmarkgpu__poselandmarkgpu__posedetectiongpu__TensorsToDetectionsCalculator",
        ...
        minTrackingConfidence: {
          ...
          graphOptionXref: {
            ...
            calculatorName:
              "holisticlandmarkgpu__poselandmarkgpu__poselandmarkbyroigpu__tensorstoposelandmarksandsegmentation__ThresholdingCalculator",
            fieldName: "threshold",
          },
        },
        cameraNear: {
